						...
						<div class="com-md-12" style="max-height:410px;overflow:auto;">
							<table class="table">
								...
								$sn=1;
									...
									$sqlGet=mysqli_query($con,"SELECT *FROM sessions WHERE status='1' ORDER BY title DESC");
									if($sqlGet){
                                    ...
                                    if($current_session==1){
                                        ...
                                        <i class="fas fa-good pull-right"></i> Active
                                        
                                     </div>';
                                    }else{
                                        echo '<div class="form-group">
                                        <i class="fas fa-ban pull-right"></i> In-active
