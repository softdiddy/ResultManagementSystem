...
?> 
 <div class="container-fluid" style="color:green">
				 ...
				 <div class="col-sm-5 border-right">
                    <div class="description-block">
                      <span class="description-text">
						 <div class="widget-user-header bg-i">NAME :<?php echo $patientName; ?></h3>
                <h5 class="widget-user-desc">NHI NO. :<?php echo $patientNHIS; ?></h5>
				<h5 class="widget-user-desc">DOB :<?php echo $patientDOB; ?></h5>
				<h5 class="widget-user-desc">GENDER :<?php echo $patientGender; ?></h5>
              </div>
					  </span>
                    </div>
                    <!-- /.description-block -->
    ...
    if($sqlGetVisit){
        ...
        if($file_position=="2"){
			$p='bg-green';
			$function='<span class="time"><a  class="btn btn-success btn-flat" style="size:20px;" href="#" data-toggle="modal" data-target="#requestForm" onclick="request_investigation('.$patient_visit_id.','.$patientID.')"><i class="fas fa-info"></i>Request </a></span>
			<button type="button" class="btn btn-success btn-flat" onclick="giveOutDrug('.$patient_visit_id.','.$patientID.')">Add Drugs Prescreption</button>';
		}else{
			$p='bg-gray';
			$function="";
		}
