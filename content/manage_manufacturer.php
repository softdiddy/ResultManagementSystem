 <div class="content-header" >
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 text-dark">Manage Manufacturers</h1><hr/>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <div class="col-md-12">
                  ...
                  <input type="text" class="form-control"  id="txtSearchDrug">
				   ...
				   <span class="input-group-append">
                    <button onclick="add_new_manufacturer()" type="button" class="btn btn-success btn-flat"> <i class="nav-icon fas fa-file-medical"></i>Add Manufacturer</button>
                  </span>
