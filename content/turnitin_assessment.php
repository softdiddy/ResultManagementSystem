 ...
 <div class="row" style="width:100%">
        ...
        <div class="input-group input-group-sm">
                  ...
                  <span class="input-group-append">
                    <button type="button" class="btn btn-sucondary btn-flat" onclick="getListOfStudentUnderFac(<?php echo $faculty_id;?>)"><i class="fas fa-arrow-left fa-md"></i>Back</button>
                  </span>
                ...
                <div class="row" style="width:100%">
                    <div class="col-md-12" style="width:100%">
                        <div style="width:60%;float:left;">
                            <?php
                           if($file !=""){
                            echo '<a href="../uploads/'.$file.'" style="color:red;">Click here to download '.$topic.'</a>';
                        }else{
                            echo '<div class="alert alert-danger" role="alert">No file Uploaded</div>';
        
                        }
                                if($file !=""){
                                    echo '<iframe src="../uploads/documents/projects/'.$file.'" style="width:100%; height:500px;"/>';
                                }else{
                                    echo '<div class="alert alert-danger" role="alert">No file Uploaded</div>';
                        ...
                        <div style="width:40%;float:right;">
                           ...
                           <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Anti-Plagiarism Originality Report</h3>
                            </div>
                                <table class="table">
                                    <tr>
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td style="30%">
                                            <button type="button" class="btn btn-default" onclick="SubmitTurnitinResult(<?php echo $student_id; ?>)">Submit</button>
                                        </td>
