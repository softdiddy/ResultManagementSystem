        ...
        if($sql_getRow > 0){
            ...
            if($turnitin_status==0){
                echo' <tr>
                    ...
                    <td>'.$topic.'</td>
                    <td>
                    <button type="button" class="btn btn-info btn-flat" onclick="view_project_details('.$student_id.')">
                        <i class="fas fa-eye fa-md"></i> 
                        </button>
                    </td>

                    <td>
                    <button type="button" class="btn btn-success btn-flat" onclick="push_for_Approval('.$student_id.')">
