...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Result Manager</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<div class="d-flex flex-row-reverse bd-highlight">
 <div class="form-inline">
  <div class="form-group">
		<select class="form-control" id="session">
			...
			<?php
				 $sql_get_session=mysqli_query($con,"SELECT *FROM sessions ORDER BY title DESC") or die(mysqli_error($con));
    if($sql_get_session){
		...
		if($sql_get_session_row > 0){
			...
			echo '<option value="'.$session_id.'">'.$session_title.'</option>';
		}
	}
}
			?>
 ...
 <div class="form-group">
	<button id="btn-download" type="button" onclick="search_programme_courses()" class="btn btn-success"><i class="fas fa-search pull-right"></i>Search</button>
	...
	<div id="loading"></div>
            ...
            <div class="card" style="top:10px;" id="load_page_contecnt">
