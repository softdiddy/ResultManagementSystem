...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Student Information Wizard</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
	 ...
	 <section class="content">
      <div class="container-fluid">
		...
		<select class="form-control" id="session">
			...
			<?php
	$sql_get=mysqli_query($con,"SELECT *FROM sessions ORDER BY title");
    if($sql_get){
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    if($sql_get){
		...
		if($sql_get_row > 0){
			...
			echo'<option value="'.$programm_id.'">'.$programm_title.'</option>';
		}
	}
	}
			?>
   ...
   <div class="form-group">
   <button id="btn-download" type="button" onclick="upload_student()" class="btn btn-info"><i class="fas fa-upload pull-right"></i>Upload</button>
  ...
  <div id="loading"></div>
            ...
            <div class="card col-md-6" style="top:10px;float:left" id="loadUpload">
              <div class="card-header">
                <h5 class="card-title">Student Summary by Programme (Curent Session)</h5>
              </div>
              <!-- /.card-header -->
    ...
    if($sql_get){
      ...
      <div class="card col-md-6" style="top:10px;float:right">
          <div id="piechart"></div>
    </div>
		  </div>
