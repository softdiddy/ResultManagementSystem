<?php
	...
	$drug_out_ofStock=array();
		$sql_get=mysqli_query($con,"SELECT *FROM main_store ms INNER JOIN drugs d ON ms.drug_id=d.drug_id");
					...
					<td>'.$drug_size.'</td>
						...
						$tottal_cost_moved=$total_cost_purchased - ($total_cost_stocked + $total_lost);
						...
						$tottal_cost_moved = number_format($tottal_cost_moved,2,".",",");
...
?>
<div class="col-md-12">
 <h1 class="m-0 text-dark">Main Store<hr/></h1>
			<button onclick="load_drugs_in_main_store()" type="button" class="btn btn-primary pull-right">Available drugs in Main Store</button><br/>
                ...
                <div class="row" style="width:100%;">
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      ...
                      <span class="description-text">TOTAL PURCHASED</span>
                    </div>
                    <!-- /.description-block -->
                  </div>
                  <!-- /.col -->
                  ...
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                       <span class="description-percentage text-success"></span>
                      <h5 class="description-header" style="font-size:20px;">N<?php echo $tottal_cost_moved;?></h5>
                      <span class="description-text">TOTAL MOVED</span>
                    </div>
                    <!-- /.description-block -->
                  </div>
                  <!-- /.col -->
