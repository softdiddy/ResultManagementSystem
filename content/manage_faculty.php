...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Manage Faculties</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<div class="card-header">
                <button style="margin-left:2px;float:right;" id="btn-download" type="button" onclick="download_faculties()" class="btn btn-success"><i class="fas fa-download pull-right"></i></button>
						...
						<div class="com-md-12" style="max-height:410px;overflow:auto;">
							<table class="table">
								...
								$sn=1;
									...
									$sqlGet=mysqli_query($con,"SELECT *FROM faculties");
									if($sqlGet){
