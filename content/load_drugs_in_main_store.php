<div class="row" style="width:100%;">
		  ...
		  <div class="card">
              <div class="card-header">
                <h3 class="card-title">Available Drugs in the main store</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body p-0" id="dispaly_search_drugs">
                <table class="table table-striped" style="font-size:12px;">
				 ...
				 <tr>
					...
					<td>'.$generic_name.'</td>
					<td>'.$pack_quantity.'</td>
					<td>'.$peacesRemaining.'</td>
					
					<td><a onclick="move_drugs_toPhamacyStore('.$drug_stocked_id.') "href="#" style="color:red;">Move to Phamacy Store</a></td>
