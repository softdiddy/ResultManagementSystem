...
$message .= '<p style="color:#000;font-size:18px;">Your project on Ibrahim Badamasi Babangida University Lapai Anti-Plagiarism has been finaly moved to the Anti-Plagiarism Administrator Desk for further review, Kindly wait for new update</p>';
$message .= '</body></html>';

  
    $sql_Update=mysqli_query($con,"UPDATE student_project SET turnitin_status='1' WHERE student_id='$student_id'");
